...
- 请求路径： `http://127.0.0.1:8888/api/private/v1/login`
- 请求方法：post
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/users`
- 请求方法：get
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/users/:uId/state/:type`
- 请求方法：put
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/users/:id`
- 请求方法：get
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/users/:id/role`
- 请求方法：put
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/rights/:type`
- 请求方法：get
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/menus`
- 请求方法：get
- 响应数据
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/roles`
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/roles/:id`
- 请求方法：get
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/roles/:roleId/rights`
- 请求方法：post
- 请求参数：通过 `请求体` 发送给后端
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/roles/:roleId/rights/:rightId`
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/categories`
- 请求方法：get
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/categories/:id`
- 请求方法：get
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/categories/:id/attributes`
- 请求方法：get
- 请求参数
...
- 请求路径： `http://127.0.0.1:8888/api/private/v1/categories/:id/attributes/:attrid`
- 请求方法：delete
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/goods`
- 请求方法：get
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/goods/:id`
- 请求方法：get
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/goods/:id/pics`
- 请求方法：put
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/goods/:id/attributes`
- 请求方法：put
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/upload`
- 请求方法：post
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/orders`
- 请求方法：get
- 请求参数
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/orders/:id`
- 请求方法：put
- 请求参数
...
+ 请求路径：`http://127.0.0.1:8888/api/private/v1/kuaidi/:id`
...
- 请求路径：`http://127.0.0.1:8888/api/private/v1/reports/type/1`
